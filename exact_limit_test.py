...
def test_upload_file(base_url, file_path, file_size_mb):
    ...
    category_name = f"Exact Limit Test {int(time.time())}"
...
def main():
    ...
    print("\n===== Testing File Upload with 7.5MB =====\n")
    
    # Create test file
    file_path = create_test_wav_file(7.5)
    
    # Test upload
    result = test_upload_file(base_url, file_path, 7.5)
    ...
    print(f"{status} - 7.5MB file upload")
