...
def test_upload_file(base_url, file_path, file_size_mb):
    ...
    category_name = f"Edge Limit Test {int(time.time())}"
...
def main():
    ...
    print("\n===== Testing File Upload with 7.99MB =====\n")
    
    # Create test file
    file_path = create_test_wav_file(7.99)
    
    # Test upload
    result = test_upload_file(base_url, file_path, 7.99)
    ...
    print(f"{status} - 7.99MB file upload")
