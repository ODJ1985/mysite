...
def test_upload_file(base_url, file_path, file_size_mb):
    ...
    category_name = f"Exact Boundary Test {int(time.time())}"
...
def main():
    ...
    print("\n===== Testing File Upload with 8.01MB =====\n")
    
    # Create test file
    file_path = create_test_wav_file(8.01)
    
    # Test upload
    result = test_upload_file(base_url, file_path, 8.01)
    ...
    print(f"{status} - 8.01MB file upload")
